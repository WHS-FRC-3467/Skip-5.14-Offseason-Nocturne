...
public class CommandXboxPS5Controller extends CommandGenericHID {
     ...
     *         to the {@link CommandScheduler#getDefaultButtonLoop()
     ...
     * returned trigger will be true when the axis value is
     * greater than {@code threshold}.
     *
     * @param threshold the minimum axis value for the returned {@link Trigger} to
     *                  be true. This value should be in the range [0, 1] where 0
     ...
     *         the provided threshold, attached to the given event
     *         loop
     */
     ...
     * is bound to the range of [0, 1] as opposed to the usual
     * [-1, 1].
     *
     * @return The axis value.
     */
